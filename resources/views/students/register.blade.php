        ...
        <section class="flat-row v23">
            ...
            <div class="row">
                    <div class="col-md-6" style="margin-top: 50px;">
                        <h3>Program Info</h3>
                        <p style="margin-top: 30px;"><b>Tuition: </b>N{{number_format($total_fee)}}</p>
                            ...
                            <div class="flat-accordion">
                                <ol style="list-style-type: decimal !important;">
                                    ...
                                    <li style="height: 35px;">{{$course->name}} 
                                        ...
                                        @else
                                        <span class="price">{{-- N{{number_format($course->price)}} --}} Paid</span>
                                        @endif
                                    </li>
                                    @endforeach
                                </ol>
                            ...
                            <div class="col-md-12">
                                <div class="btn-contact">
                                    <p class="form-contact">                 
                                        <button class="flat-button font-poppins" type="button" onclick='payWithPaystack("{{$total_fee}}")'>Register now (N{{number_format($total_fee)}})</button>
                                    </p>
                                </div>
                            </div>          
                    </form>
