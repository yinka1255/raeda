...
<head>
	...
	<title>Yul | Book's Details</title>
			...
			<div class="col-xs-12">
				...
				<div class="col-xs-4">
					<div class="pull-right">
							<a href="{{url('admin/new_book')}}" class="btn btn-primary"><i class="entypo-user"> </i> Add new</a>
					</div>
				</div>
						...
						<table class="table table-bordered datatable" id="table-1">
							...
							<tbody>
								...
								<tr class="odd gradeX">
									...
									@endif
									<td>
									<a href="{{url('admin/edit_book/'.$book->id)}}" class="btn btn-primary btn-sm btn-icon icon-left">
										<i class="entypo-pencil"></i>
										Edit
									</a>
									@if($book->status == 1)
									<a href="{{url('admin/deactivate_book/'.$book->id)}}" class="btn btn-danger btn-sm btn-icon icon-left">
										<i class="entypo-cancel"></i>
										Deactivate
									</a>
								@elseif($book->status == 2)
									<a href="{{url('admin/activate_book/'.$book->id)}}" class="btn btn-success btn-sm btn-icon icon-left">
										<i class="entypo-cancel"></i>
										Activate
									</a>
								@endif
