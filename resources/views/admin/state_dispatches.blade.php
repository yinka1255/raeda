                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h4 class="page-title">{{$state->name}} Dispatches</h4>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-right">
                                    <li class="breadcrumb-item"><a href="{{url('admin/index')}}">Dashboard</a></li>
                                    <li class="breadcrumb-item active">{{$state->name}} Dispatches</li>
                                </ol>
                            </div>
                        </div>
                        <!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form class="form-horizontal row"  method="POST" action="{{url('admin/state_dispatches')}}">
                                        {{ csrf_field() }}
                                        <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">{{$state->name}} dispatches</h4>
