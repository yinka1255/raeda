                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <form class="form-horizontal m-t-30"  method="POST" action="{{url('admin/save_item_to_cart')}}">
                                        {{ csrf_field() }}
                        ...
                        <div class="col-xl-6">
                            <div class="card m-b-30">
                                <div class="card-body" style="min-height: 530px;">
                                    ...
                                    @else
                                    <a href="{{url('admin/new_dispatch_address')}}" class="btn btn-primary btn-block btn-lg waves-effect waves-light" type="submit">Continue</a>
                                    @endif
                                </div>
                            </div>
                        </div>
